...
The same limitations pertain to C<Proc::tored::Pool> as apply to
L<Parallel::ForkManager>, including an injunction against using two pools
simultaneously from the same process. See
L<Parallel::ForkManager/BUGS AND LIMITATIONS> for details.
